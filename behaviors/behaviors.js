...
export const savedBehaviorConfigs = {
    red_default: { laserColor: 0xff0000 },
    green_lasers: { laserColor: 0x00ff00 },
    blue_bounce: { laserColor: 0x0000ff, MAX_BOUNCES: 5 },
    yellow_wide: { laserColor: 0xffff00, ORIGIN_SPHERE_RADIUS: 15 }
};
