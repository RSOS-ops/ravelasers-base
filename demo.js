...
console.log(`const fireBehavior = new LaserEngine({ 
...
console.log(`const zenBehavior = new LaserEngine({ 
...
console.log(`const chaosBehavior = new LaserEngine({ 
...
console.log(`const originalSpeed = new LaserEngine({ 
    laserColor: 0xff0000, 
...
console.log(`const doubleSpeed = new LaserEngine({ 
    laserColor: 0x00ff00, 
...
console.log(`const quadSpeed = new LaserEngine({ 
    laserColor: 0x0080ff, 
...
console.log(`const purpleFast = new LaserEngine({ 
    laserColor: 0x8000ff, 
...
console.log("3. Create custom: Use the LaserEngine examples above");
