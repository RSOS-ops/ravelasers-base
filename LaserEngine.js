...
export class LaserEngine {
    constructor(config = {}) {
        ...
        this.config = {
            ...
            STILLNESS_LIMIT: config.STILLNESS_LIMIT || 0.08333333333333333,
    ...
    init(laserSystem) {
        console.log('LaserEngine: Initializing behavior with config:', this.config);
        ...
        console.log(`LaserEngine: Created behavior with ${this.lasers.length} lasers`);
    }
    ...
    cleanup(laserSystem) {
        console.log('LaserEngine: Cleaning up behavior');
